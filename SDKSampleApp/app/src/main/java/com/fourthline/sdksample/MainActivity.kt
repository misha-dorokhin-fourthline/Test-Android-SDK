...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupButtons() = with(binding) {
        ...
        buttonOrcaWithKyc.setOnClickListener{ startOrcaWithKycLauncher() }
        buttonOrcaWithQes.setOnClickListener{ startOrcaWithQes() }
        buttonOrcaWithDocumentProduct.setOnClickListener{ startOrcaWithDocumentProduct() }
        buttonOrcaWithNfcProduct.setOnClickListener{ startOrcaWithNfcProduct() }
        buttonOrcaWithSelfieProduct.setOnClickListener{ startOrcaWithSelfieProduct() }
    }

    private fun startOrcaWithKycLauncher() {
        val intent = Intent(this, OrcaKycSampleActivity::class.java)
        startActivity(intent)
    }

    private fun startOrcaWithQes() {
        val intent = Intent(this, OrcaQesSampleActivity::class.java)
        startActivity(intent)
    }

    private fun startOrcaWithDocumentProduct() {
        val intent = Intent(this, OrcaDocumentProductSampleActivity::class.java)
        startActivity(intent)
    }

    private fun startOrcaWithSelfieProduct() {
        val intent = Intent(this, OrcaSelfieProductSampleActivity::class.java)
        startActivity(intent)
    }

    private fun startOrcaWithNfcProduct() {
        val intent = Intent(this, OrcaNfcProductSampleActivity::class.java)
        startActivity(intent)
    }
