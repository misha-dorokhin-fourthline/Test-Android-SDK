...
class DocumentActivity : DocumentScannerActivity() {
     ...
     * the required method [DocumentScannerActivity.getOverlayView].
     *
    ...
    private val scannerOverlayView by lazy {
        DocumentScannerOverlayView(this).apply {
            configureButtons(
                documentScanner = this@DocumentActivity,
    ...
    /**
     * [DocumentScanner] will start automatically when this is set to **true**.
     * [DocumentScanner] must be started manually by calling [DocumentScanner.startScanner] when this is set to **false**.
     */
    ...
    /**
     * Configuration for the [DocumentScannerActivity].
    ...
    /**
     * Handle the start of new steps during scanning, as returned by [DocumentScannerActivity].
     *
    ...
    /**
     * Handle warnings during scanning, as returned by [DocumentScannerActivity].
     *
    ...
    /**
     * Handle errors of individual steps that fail, as returned by [DocumentScannerActivity].
     */
    ...
    /**
     * Handle results of individual steps that succeed, as returned by [DocumentScannerActivity].
     */
    ...
    /**
     * Handle errors returned by [DocumentScannerActivity].
     */
    ...
    /**
     * Handle successful [DocumentScannerResult] returned by [DocumentScannerActivity].
     */
    override fun onSuccess(result: DocumentScannerResult) = runOnUiThread {
        ...
        // Continue with the user journey
