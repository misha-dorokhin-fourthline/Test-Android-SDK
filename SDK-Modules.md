...
- Data source will be asked for:
    ...
    | autoDetectStepDuration         | long                                     | 40                               | Defines the maximum duration of auto-detect for steps that support it. |
...
- Callbacks will be informed about:
    ...
    <br>Document scanner step is combination of `DocumentFileSide`
        ...
        | isAutoDetectAvailable | Boolean determining if `DocumentScanner` will try to scan page automatically<br>💡 Automatic scanning duration can be set with `DocumentScannerConfig.autoDetectStepDuration` variable |
